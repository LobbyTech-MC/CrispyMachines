...
public final class Items {
    ...
    public static final SlimefunItemStack DIESEL_GENERATOR_BIG = new SlimefunItemStack("DIESEL_GENERATOR_BIG", Material.BLAST_FURNACE, "&e大型柴油发电机", "&7 400 J 缓存", "&7 100 J/s");
    public static final SlimefunItemStack GASOLINE_GENERATOR = new SlimefunItemStack("CM_GASOLINE_GENERATOR", Material.BLAST_FURNACE, "&e汽油发电机", "&7 200 J 缓存", "&7 50 J/s");
